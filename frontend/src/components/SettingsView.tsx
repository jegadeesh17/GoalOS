      ...
      <div className="glass-panel rounded-3xl p-6 sm:p-7 space-y-4 shadow-forest border border-emerald-100/70">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 rounded-2xl border border-emerald-100 bg-white/90 gap-3 shadow-forest-xs">
          ...
          <button
            ...
            className="flex items-center justify-center space-x-1.5 bg-gradient-to-r from-emerald-50 to-teal-50 hover:from-emerald-100 hover:to-teal-100 text-emerald-950 border border-emerald-200/80 px-4 py-2 rounded-full text-xs font-semibold transition-all shadow-forest-xs flex-shrink-0 cursor-pointer"
          >
